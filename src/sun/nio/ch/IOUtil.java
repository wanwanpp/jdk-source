...
class IOUtil {
        ...
        throws IOException
    {
        ...
        try {
            ...
            sun.nio.ch.Util.offerFirstTemporaryDirectBuffer(bb);
        }
    }
        ...
        throws IOException
    {
        ...
        try {
            ...
            for (int i=offset; i<count; i++) {
                ...
                if (rem > 0) {
                    ...
                    if (!(buf instanceof DirectBuffer)) {
                        ByteBuffer shadow = sun.nio.ch.Util.getTemporaryDirectBuffer(rem);
                        shadow.put(buf);
                        shadow.flip();
            ...
            for (int j=0; j<iov_len; j++) {
                ...
                if (shadow != null)
                    sun.nio.ch.Util.offerLastTemporaryDirectBuffer(shadow);
                vec.clearRefs(j);
            }
        ...
        throws IOException
    {
        ...
        // Substitute a native buffer
        ByteBuffer bb = sun.nio.ch.Util.getTemporaryDirectBuffer(dst.remaining());
        try {
