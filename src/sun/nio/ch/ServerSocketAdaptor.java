    ...
    extends ServerSocket
{
    ...
    public InetAddress getInetAddress() {
        if (!ssc.isBound())
            return null;
        return sun.nio.ch.Net.asInetSocketAddress(ssc.localAddress()).getAddress();
    }

    public int getLocalPort() {
        if (!ssc.isBound())
            return -1;
        return sun.nio.ch.Net.asInetSocketAddress(ssc.localAddress()).getPort();
    }
            ...
            try {
                ...
                try {
                    ...
                    if ((sc = ssc.accept()) != null)
                        return sc.socket();
                    sel = sun.nio.ch.Util.getTemporarySelector(ssc);
