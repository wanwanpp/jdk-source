    ...
    implements sun.nio.ch.Cancellable, sun.nio.ch.Groupable
{
    ...
    AsynchronousSocketChannelImpl(sun.nio.ch.AsynchronousChannelGroupImpl group)
        throws IOException
    {
                                                ...
                                                CompletionHandler<V,? super A> handler)
    {
        if (!isOpen()) {
            ...
            if (handler == null)
                return sun.nio.ch.CompletedFuture.withFailure(e);
            sun.nio.ch.Invoker.invoke(this, handler, att, null, e);
            return null;
        }
        ...
        if (shutdown || !hasSpaceToRead) {
            ...
            if (handler == null)
                return sun.nio.ch.CompletedFuture.withResult((V)result);
            sun.nio.ch.Invoker.invoke(this, handler, att, (V)result, null);
            return null;
        }
                               ...
                               CompletionHandler<Long,? super A> handler)
    {
        ...
        ByteBuffer[] bufs = sun.nio.ch.Util.subsequence(dsts, offset, length);
                                 ...
                                 CompletionHandler<Long,? super A> handler)
    {
        ...
        if ((offset < 0) || (length < 0) || (offset > srcs.length - length))
            throw new IndexOutOfBoundsException();
        srcs = sun.nio.ch.Util.subsequence(srcs, offset, length);
