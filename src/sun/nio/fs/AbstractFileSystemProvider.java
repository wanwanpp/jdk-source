...
abstract class AbstractFileSystemProvider extends FileSystemProvider {
     ...
     */
    abstract sun.nio.fs.DynamicFileAttributeView getFileAttributeView(Path file,
                                                                      String name,
                                                                      LinkOption... options);
        ...
        throws IOException
    {
        ...
        sun.nio.fs.DynamicFileAttributeView view = getFileAttributeView(file, s[0], options);
        if (view == null)
