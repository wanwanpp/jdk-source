...
public class Big5_Solaris extends Charset implements HistoricallyNamedCharset
{
    ...
    public CharsetDecoder newDecoder() {
        initb2c();
        return new  sun.nio.cs.ext.DoubleByte.Decoder(this, b2c, b2cSB, 0x40, 0xfe);
    }

    public CharsetEncoder newEncoder() {
        initc2b();
        return new sun.nio.cs.ext.DoubleByte.Encoder(this, c2b, c2bIndex);
    }
    ...
    static void initb2c() {
        ...
        synchronized (Big5_Solaris.class) {
            ...
            int[] sol = new int[] {
                ...
                0xF9DB, 0x7CA7,
                0xF9DC, 0x5AFA };
            if (b2c[0xf9] == sun.nio.cs.ext.DoubleByte.B2C_UNMAPPABLE) {
