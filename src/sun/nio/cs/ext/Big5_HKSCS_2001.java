...
public class Big5_HKSCS_2001 extends Charset
{
    ...
    private static class Decoder extends sun.nio.cs.ext.HKSCS.Decoder {
        private static sun.nio.cs.ext.DoubleByte.Decoder big5 =
            (sun.nio.cs.ext.DoubleByte.Decoder)new Big5().newDecoder();
    ...
    private static class Encoder extends sun.nio.cs.ext.HKSCS.Encoder {
