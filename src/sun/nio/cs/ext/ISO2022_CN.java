    ...
    implements HistoricallyNamedCharset
{
    ...
    public boolean contains(Charset cs) {
        return ((cs instanceof EUC_CN)     // GB2312-80 repertoire
                ...
                || (cs instanceof sun.nio.cs.ext.EUC_TW)  // CNS11643 repertoire
    ...
    static class Decoder extends CharsetDecoder {
        ...
        private static final Charset cns = new sun.nio.cs.ext.EUC_TW();
        ...
        Decoder(Charset cs) {
            ...
            gb2312Decoder = (sun.nio.cs.ext.DoubleByte.Decoder)gb2312.newDecoder();
