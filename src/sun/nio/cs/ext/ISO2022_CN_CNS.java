...
public class ISO2022_CN_CNS extends sun.nio.cs.ext.ISO2022 implements HistoricallyNamedCharset
{
    ...
    public boolean contains(Charset cs) {
        ...
        return ((cs instanceof sun.nio.cs.ext.EUC_TW) ||
    ...
    public CharsetDecoder newDecoder() {
        return new sun.nio.cs.ext.ISO2022_CN.Decoder(this);
    }
    ...
    private static class Encoder extends sun.nio.cs.ext.ISO2022.Encoder {
