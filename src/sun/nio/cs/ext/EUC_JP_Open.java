    ...
    implements HistoricallyNamedCharset
{
    ...
    public boolean contains(Charset cs) {
        return ((cs.name().equals("US-ASCII"))
                || (cs instanceof sun.nio.cs.ext.JIS_X_0201)
                || (cs instanceof sun.nio.cs.ext.EUC_JP));
    }
    ...
    private static class Decoder extends sun.nio.cs.ext.EUC_JP.Decoder {
        ...
        private Decoder(Charset cs) {
            super(cs);
            decoderJ0201 = new sun.nio.cs.ext.JIS_X_0201.Decoder(cs);
    ...
    private static class Encoder extends sun.nio.cs.ext.EUC_JP.Encoder {
