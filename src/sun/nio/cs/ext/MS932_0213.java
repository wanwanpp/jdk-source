...
public class MS932_0213 extends Charset {
    ...
    protected static class Decoder extends sun.nio.cs.ext.SJIS_0213.Decoder {
        static sun.nio.cs.ext.DoubleByte.Decoder decMS932 =
            (sun.nio.cs.ext.DoubleByte.Decoder)new MS932().newDecoder();
    ...
    protected static class Encoder extends sun.nio.cs.ext.SJIS_0213.Encoder {
