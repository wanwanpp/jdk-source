...
public abstract class AbstractMap<K, V> implements Map<K, V> {
     ...
     * @throws NullPointerException {@inheritDoc}
     */
    //AbstractMap中的是遍历entrySet
    //但是像HashMap等子类有自己的实现方式。
     ...
     * @throws NullPointerException          {@inheritDoc}
     */
    //先迭代entrySet，找到正确的entry，再使用迭代器从entrySet中删除，返回正确的entry的value
