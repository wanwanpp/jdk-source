...
//使用完ThreadLocal后一定要remove一下，保证及时回收掉无用的Entry。
        ...
        private boolean cleanSomeSlots(int i, int n) {
            ...
            do {
                ...
                if (e != null && e.get() == null) {
                    //一旦发现一个位置对应的Entry所持有的ThreadLocal弱引用为null，
                    // 就会把此位置当做staleSlot并调用expungeStaleEntry方法进行整理(rehashing)
                    n = len;
                    removed = true;
